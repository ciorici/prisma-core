...
if ( ! class_exists( 'Prisma_Core_Customizer_Widget_Socials' ) ) :

	/**
	 * Prisma Core Customizer widget class
	 */
	class Prisma_Core_Customizer_Widget_Socials extends Prisma_Core_Customizer_Widget_Nav {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="prisma-core-widget-socials-style">
					<label for="widget-socials-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-style">
						<?php esc_html_e( 'Style', 'prisma-core' ); ?>:
					</label>
